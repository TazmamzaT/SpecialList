...
/**
 * An AbstractSpecialList is the superclass of a SpecialList implemented as a
 * singly-linked list without header/trailer nodes. What is special about it is
 * that although duplicate values are allowed, there will never be two
 * consecutive elements with the same value. For example, [4,9,4] is ok, but
 * [4,4,9] should never occur.
 */
